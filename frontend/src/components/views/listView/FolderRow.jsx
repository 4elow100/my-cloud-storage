...
export const FolderRow = ({item, onDoubleClick}) => {
  const {openContextMenu, setCurrentFileName, setCurrentElemAPILink, setCurrentElemId, setCurrentElemRef} = useContextMenu()
  ...
  return (
    <>
      <ListRow onContextMenu={handleContextMenu} elemTypeClass='item-type-folder' onDoubleClick={handleDoubleClick}
               item_id={item.id}>
